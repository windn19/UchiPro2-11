...
from directorsgenres import Genres, Directors
...
class Window(QWidget, Ui_Form):
    def __init__(self):
        ...
        self.directorsButton.clicked.connect(self.showDirectorsWindow)
        self.genresButton.clicked.connect(self.showGenresWindow)
    ...
    def showDirectorsWindow(self):
        self.directorWindow = Directors(self.con)
        self.directorWindow.exec()
        self.showMovies()
        self.showDirectors()

    def showGenresWindow(self):
        self.genreWindow = Genres(self.con)
        self.genreWindow.exec()
        self.showGenres()
