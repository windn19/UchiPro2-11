...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Жанры"))
        self.label.setText(_translate("Form", "Название"))
        self.addButton.setText(_translate("Form", "Добавить жанр"))
        self.editButton.setText(_translate("Form", "Изменить жанр"))
        self.deleteButton.setText(_translate("Form", "Удалить жанр"))
